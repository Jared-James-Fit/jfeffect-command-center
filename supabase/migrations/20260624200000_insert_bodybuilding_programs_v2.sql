...
-- Skips any template whose name already exists (no unique
-- constraint on pl_templates.name, so we guard with NOT EXISTS
-- which is equivalent to ON CONFLICT (name) DO NOTHING).
-- ============================================================
