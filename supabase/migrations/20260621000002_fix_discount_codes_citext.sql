-- ============================================================
-- Migration: Fix discount_codes citext error
-- Purpose: 
--   1. Ensure citext extension is enabled.
--   2. Alter the validate_discount_codes function to use 
--      lower() instead of ::citext cast to avoid "type citext does not exist"
--      errors depending on search_path.
-- ============================================================

-- Ensure the extension exists in the public schema
CREATE EXTENSION IF NOT EXISTS citext WITH SCHEMA public;

-- Update the validation function to use lower() for safer comparison
...
BEGIN
  ...
  FOREACH code_text IN ARRAY _codes LOOP
    ...
    -- FIX: Use lower() instead of ::citext cast to prevent type errors
