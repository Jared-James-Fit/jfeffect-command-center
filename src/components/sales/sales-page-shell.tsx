...
export function SalesPageShell({
  ...
  return (
    <div
      ...
      data-theme={theme}
    >
      <header className={`z-40 bg-background/90 backdrop-blur ${floatingHeader ? "sticky top-3 mt-3 mx-3 rounded-2xl border border-border shadow-lg" : "sticky top-0 border-b border-border"}`}>
