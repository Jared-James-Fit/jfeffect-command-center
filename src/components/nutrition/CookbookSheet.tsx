...
import { BookOpen, ChefHat, Clock, Flame, Beef, Loader2, SlidersHorizontal } from "lucide-react";
...
const CookbookBody = lazy(() =>
  Promise.resolve({ default: CookbookContent }),
);
...
function CookbookContent({ viewer }: { viewer: CookbookViewer }) {
